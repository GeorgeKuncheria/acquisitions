...
//             case 'admin':
//                 limit = 20;
//                 message= 'Admin limit exceeded(20 requests per minute).Slow down';
//                 break;
            
//             case 'user':
//                 limit = 10;
//                 message= 'User limit exceeded(10 requests per minute).Slow down';
//                 break;
            
//             case 'guest':
//                 limit = 5;
//                 message= 'Guest limit exceeded(5 requests per minute).Slow down';
//                 break;
//         }
//         const client =  aj.withRules(slidingWindow({
//             mode:'LIVE',
//             interval:'1m',
//             max: limit,
...
//             logger.warn('Bot detected:', {ip: req.ip, userAgent: req.get('User-Agent'), path: req.path});
//             return res.status(403).json({ error: 'Forbidden' });
//         }


//         if (decision.isDenied() && decision.reason.isShield()) {
//             logger.warn('Shield triggered:', {ip: req.ip, userAgent: req.get('User-Agent'), path: req.path, method: req.method});
